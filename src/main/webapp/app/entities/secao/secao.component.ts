...
export class SecaoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.secaoService
            ...
            .subscribe(
                (res: HttpResponse<ISecao[]>) => this.paginateSecaos(res.body, res.headers),
    ...
    trackId(index: number, item: ISecao) {
        return item.id;
    }
    ...
    private paginateSecaos(data: ISecao[], headers: HttpHeaders) {
