...
import { RotuloComponent } from 'app/entities/rotulo/rotulo.component';
import { RotuloService } from 'app/entities/rotulo/rotulo.service';
import { Rotulo } from 'app/shared/model/rotulo.model';

describe('Component Tests', () => {
    describe('Rotulo Management Component', () => {
        let comp: RotuloComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RotuloComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.rotulos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
