...
import { GlossarioComponent } from 'app/entities/glossario/glossario.component';
...
describe('Component Tests', () => {
    describe('Glossario Management Component', () => {
        let comp: GlossarioComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GlossarioComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.glossarios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
