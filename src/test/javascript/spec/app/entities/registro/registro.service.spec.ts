...
describe('Service Tests', () => {
    describe('Registro Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RegistroService);
        ...
        describe('Service methods', () => {
            ...
            it('should create a Registro', () => {
                service.create(new Registro(null)).subscribe(received => {
            ...
            it('should update a Registro', () => {
                service.update(new Registro(123)).subscribe(received => {
